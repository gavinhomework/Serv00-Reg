...
if __name__ == "__main__":
    ...
    # 从环境变量中读取邮箱
    email_from_env = os.getenv("EMAIL")
    if email_from_env:
        logger.info(f"从环境变量读取邮箱: {email_from_env}")
        start_task(email_from_env)
    else:
        while True:
